    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(related_name='published_books', to='booksdatabase.author')),
                ('categories', models.ManyToManyField(related_name='published_books', to='booksdatabase.category')),
